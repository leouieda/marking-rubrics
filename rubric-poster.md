# Rubric for marking a poster

Marking rubric with level descriptors and respective marks for different
...
<table border=1>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Presentation: Legibility, size of elements, layout, aesthetics of the design</th>
    ...
    <tr>
      <th scope="row">Figures: Use of figures/maps/tables/illustrations</th>
      <td>No use of figures, diagrams, tables, etc.</td>
      <td>Insufficient figures/tables, no caption and not referred to in the text</td>
    ...
    <tr>
      <th scope="row">Evidence: Breadth, depth, and accuracy of evidence presented, knowledge of the methodology</th>
